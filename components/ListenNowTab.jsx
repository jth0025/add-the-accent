 ...
 * treatment of Apple Music's own promo graphics: a tiny "MUSIC" label up
 * top, the Apple mark beside a short "Continue the vibe" line, then the
 * station name as the one large, unmissable word, framed by two small
 * connecting words. The frame art (listen-now-frame.png) is already solid
      ...
      >
        <span className="relative block w-full">
          ...
          <div className="absolute left-[24%] right-[24%] top-[8%] bottom-[8%] flex flex-col items-center justify-center gap-0.5 text-center">
            {/* Small "MUSIC" label, echoing the reference art. */}
            <span className="font-sans text-[7px] font-bold uppercase tracking-wide text-white/90 [text-shadow:0_1px_3px_rgba(0,0,0,0.9)] sm:text-[8px]">
              Music
            </span>

            {/* Apple mark beside the tagline, sitting on top of the main
                "through GREEN MAIZE radio" line. */}
            <span className="flex items-center gap-1 whitespace-nowrap font-sans text-[7px] font-medium uppercase tracking-wide text-white/80 [text-shadow:0_1px_3px_rgba(0,0,0,0.9)] sm:text-[8px]">
              <svg
                viewBox="0 0 24 24"
