...
export default function VoiceClip({ src, label = "Voice note" }) {
  ...
  return (
    <div className="corner-box on-dark flex w-full max-w-sm items-center gap-3 rounded-lg border border-white/25 bg-white/10 px-4 py-3 text-left backdrop-blur-sm md:rounded-r-none">
      <button
        type="button"
        onClick={toggle}
